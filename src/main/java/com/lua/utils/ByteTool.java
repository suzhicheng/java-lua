...
public class ByteTool {
	...
	public static String mulByteToHexString(byte[] arr, int offset, int len) {
		String tmp = "";
		for (int i = 0; i < len; i++) {
			tmp += oneByteToHexString(arr[offset + i]);
		}
		return tmp;
	}
	...
	public static int getNetWorkAvailability() {
		return Integer.parseInt(System.getProperty("networkavailability"));
	}

	public static int getNetWorkSignal() {
		return Integer.parseInt(System.getProperty("networksignal"));
	}
	...
	public static int oneIntToShort(int b) {
		return (b & 0xFFFF);
	}

	public static String oneDcdByteToString(byte b) {
		String tmp = "";
		int a = (b >> 4) & 0x0f;
		tmp = tmp + a;
		a = b & 0x0f;
	...
	public static String mcmTMtoString(byte[] data, int offset) {
		int itm = ByteTool.lsbByteToInteger(data, offset);
	...
	public static String calCRC16(byte data[], int start, int len) {
		...
		return ByteTool.makeupZero(
				String.valueOf(ByteTool.lsbByteToShort(crcData, 0)), 5);
		// return
	...
	public static void main(String agr[]) {
		...
		// String str =
		// "22197C77AD7980001007220000000137013724101999999201010121513550000000000000004000000040000000000000400000000000201010121513490000000000000000137000000000000000000000000000000000000000000000000000127205010000000057980004746FB1E02580000";
		//
		// System.out.println(ByteTool.crc16_ccitt(str));
		byte[] ba = new byte[4];
		setUINT4(ba, 0, 7200, true);
		for (int i = 0; i < 4; i++) {
